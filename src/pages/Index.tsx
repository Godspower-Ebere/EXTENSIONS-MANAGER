        ...
        <div className="space-y-8">
                ...
                <Button
                  ...
                  className={`capitalize rounded-full px-6 transition-all duration-300 ${
                    activeFilter === filter
                      ...
                      : "border-gray-300 hover:border-gray-400 bg-white/30 hover:bg-white/50"
                  }`}
                >
                  {filter}
                </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredExtensions.map((extension) => (
              <div
                key={extension.id}
                className={`${cardClasses} border rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl backdrop-blur-sm`}
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-700/30">
                  ...
                  <Switch
                    checked={extensionStates[extension.id]}
